...
pub struct SpatialNagivation<'a> {
    tree: &'a mut Tree,
    rects: HashMap<TaffyNodeId, NodeInfo>,
}
impl<'a> SpatialNagivation<'a> {
    ...
    fn remove_target(list: &mut Vec<TaffyNodeId>, target: TaffyNodeId) {
...
impl SpatialNagivation<'_> {
    /// https://developer.mozilla.org/en-US/docs/Web/API/Element/getBoundingClientRect
    fn get_bounding_client_rect(&self, node: TaffyNodeId) -> Option<BoundingBox> {
    ...
    fn get_rect(&mut self, node: TaffyNodeId) -> Option<NodeInfo> {
