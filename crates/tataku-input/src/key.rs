...
impl Key {
    ...
    pub fn to_logical(&self) -> winit::keyboard::Key {
        use winit::keyboard::{ Key as WinitKey, NamedKey };
        match self {
            Key::Left => WinitKey::Named(NamedKey::ArrowLeft),
            Key::Right => WinitKey::Named(NamedKey::ArrowRight),
            Key::Up => WinitKey::Named(NamedKey::ArrowUp),
            Key::Down => WinitKey::Named(NamedKey::ArrowDown),
            Key::Backspace => WinitKey::Named(NamedKey::Backspace),
            Key::Delete => WinitKey::Named(NamedKey::Delete),
            Key::Tab => WinitKey::Named(NamedKey::Tab),
            Key::Enter => WinitKey::Named(NamedKey::Enter),
...
impl KeyInput {
    ...
    #[cfg(debug_assertions)]
    pub fn test_key_text(text: &str) -> Self {
        use winit::keyboard::*;
        Self {
            physical: PhysicalKey::Unidentified(NativeKeyCode::Unidentified),
            logical: Key::Character(SmolStr::new(text)),
    ...
    #[cfg(debug_assertions)]
    pub fn test_key(key: Key) -> Self {
        use winit::keyboard::*;
        Self {
            physical: PhysicalKey::Unidentified(NativeKeyCode::Unidentified),
            logical: key.to_logical(),
            location: KeyLocation::Standard,
            text: None,
            repeat: false,
        }
