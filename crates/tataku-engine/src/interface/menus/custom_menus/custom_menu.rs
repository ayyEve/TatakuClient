...
impl CustomMenu {
    pub async fn build(&self, skin_manager: &mut dyn SkinProvider) -> BuiltCustomMenu {
...
impl AsyncMenu for BuiltCustomMenu {
    ...
    async fn handle_event(&mut self, event: TatakuEventType, event_value: Option<TatakuValue>, values: &mut dyn Reflect) {
