...
const TITLE_FONT_SIZE:f32 = TOOLBAR_HEIGHT * 0.8;
...
impl Dialog for DraggableDialog {
    ...
    async fn update(&mut self, values: &mut ValueCollection) -> Vec<TatakuAction> { self.inner.update(values).await }
}
...
// }
// impl DraggableDialog {
//     pub fn new(pos: impl Into<DraggablePosition>, inner: Box<dyn Dialog>) -> Self {
