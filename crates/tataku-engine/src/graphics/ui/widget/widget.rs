...
pub trait Widget: Send + Sync {
    ...
    fn all_children(&self) -> WidgetChildren { self.children() }
    fn all_children_mut(&mut self) -> WidgetChildrenMut { self.children_mut() }

    /// helper for default actions
    fn children(&self) -> WidgetChildren { WidgetChildren::None }
    /// helper for default actions
