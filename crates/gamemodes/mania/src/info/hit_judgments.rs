...
impl ManiaHitJudgments {
    pub const Marvelous: HitJudgment = HitJudgment::new(
        ...
        330,
        COMBO_MULTIPLIER,
        Color::new_f32(0.9800, 0.9960, 0.7098, 1.0),
        "",
        false,
        false,
    );
    ...
    pub const Perfect: HitJudgment = HitJudgment::new(
        ...
        300,
        COMBO_MULTIPLIER,
        Color::new_f32(0.9608, 0.8706, 0.4087, 1.0),
        "",
        false,
        false,
    );
    ...
    pub const Great: HitJudgment = HitJudgment::new(
        ...
        200,
        COMBO_MULTIPLIER,
        Color::new_f32(0.3372, 0.9922, 0.4314, 1.0),
        "",
        true,
        false,
    );
    ...
    pub const Good: HitJudgment = HitJudgment::new(
        ...
        100,
        COMBO_MULTIPLIER,
        Color::new_f32(0.0, 0.8157, 0.9961, 1.0),
        "",
        true,
        false,
    );  
    ...
    pub const Okay: HitJudgment = HitJudgment::new(
        ...
        50,
        COMBO_MULTIPLIER,
        Color::new_f32(0.7451, 0.3725, 0.7098, 1.0),
        "",
        true, 
        true
    );
    ...
    pub const Miss: HitJudgment = HitJudgment::new(
        ...
        Color::new_f32(0.9725, 0.3921, 0.3647, 1.0),
        "",
        true,
        true,
    );
