...
//     pub fn new() -> Self {
//         Self {
//             acc_text: Text::new(Vector2::ZERO, 30.0, "100.00%", Color::WHITE, Font::Main),
...
//         if last_acc != self.acc {
//             self.size = self.acc_image.as_ref()
//                 .map(|i| i.measure_text())
//                 .unwrap_or_else(|| self.acc_text.measure_text())
//         }
//     }
...
//             // let right_align = self.bounds_size.x - text_size.x;right_align
