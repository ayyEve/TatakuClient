...
//         pub fn new() -> (Pokedex, Command<Message>) {
//             (
//                 Pokedex::Loading,
...
//     //     fn view(&self) -> Element<Message, crate::prelude::IcedRenderer> {
...
//             // return Err(Error::LanguageError);
//             println!("searching");
...
//     fn button(text: &str) -> widget::Button<'_, Message, crate::prelude::IcedRenderer> {
//         widget::button(text).padding(10).on_press(on_press)
//     }
// }
