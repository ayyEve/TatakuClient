...
impl OsuHitJudgments {
    pub const X300: HitJudgment = HitJudgment::new(
        ...
        300,
        COMBO_MULTIPLIER,
        Color::new_f32(0.0, 0.7647, 1.0, 1.0),
        "hit300",
        false, 
        false,
    );
    pub const X100: HitJudgment = HitJudgment::new(
        ...
        100,
        COMBO_MULTIPLIER,
        Color::new_f32(0.3411, 0.8901, 0.0745, 1.0),
        "hit100",
        true, 
        false,
    );
    pub const X50: HitJudgment = HitJudgment::new(
        ...
        50,
        COMBO_MULTIPLIER,
        Color::new_f32(0.8549, 0.6823, 0.2745, 1.0),
        "hit50",
        true, 
        true,
    );
    pub const Miss: HitJudgment = HitJudgment::new(
        ...
        Color::new_f32(0.9, 0.05, 0.05, 1.0),
        "hit0",
        true, 
        true,
    );
