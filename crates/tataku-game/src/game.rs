...
impl Game {
    ...
    fn init(&mut self) {
        ...
        #[cfg(feature="gameplay")]
        self.input_manager.set_double_tap_protection(self.settings.enable_double_tap_protection.then_some(self.settings.double_tap_protection_duration));
