    ...
    fn view(&self, _values: &mut ShuntingYardValues) -> IcedElement {
        ...
        col!(
            ...
            row!(
                ...
                // sort by
                Dropdown::new(sort_bys, Some(self.settings.sort_by.to_string()), move|value|Message::new(owner, "sort_by", MessageType::Dropdown(value))).width(FillPortion(1)).text_size(20.0).into_element(),
